...
const Source = new Schema(
  {
    ...
    type: { type: String, enum: Object.values(SourceTypes), default: null },
...
Source.index({ name: "text" });
Source.index({ user_location: "2dsphere" });

export default model<any, AggregatePaginateModel<any>>("Source", Source);
