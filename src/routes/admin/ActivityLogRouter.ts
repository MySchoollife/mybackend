        ...
        this.router.get(
            ...
            async (req, res, next) => {
                try {
                    ...
                    const filter: any = { user_id: new mongoose.Types.ObjectId(id) }

                    if (req.query.page) page = parseInt(req.query.page);
                    if (req.query.pageSize) pageSize = parseInt(req.query.pageSize);

                    let total = await ActivityLog.countDocuments(filter)
                    ...
                    return _RS.apiNew(res, true, "Activity log retrieved successfully", {
                        data,
                        total,
                        page,
                        pageSize
...
export default new ActivityLogRouter().router;
